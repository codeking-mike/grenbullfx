    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                <h4>Bank Deposit</h4>
                <p>Kindly deposit N<?php echo $amount ?> into the Bank Account below.</p>
              </div>
              ...
              <div class="card-body">
				  ...
				  <p>Account Name:<br>
				  <input type="text" value="<?php echo $acc_name ?>" style="width:100%;background:#f98604;color:#fff" readonly /><br>
				  
				  </p>
                  <p>Account Number:<br>
				  <input type="text" id="link" value="<?php echo $acc_number ?>" style="width:100%;background:#f98604;color:#fff" readonly /><br>
				  <button id="copy" onclick="copyLink2()" class="btn btn-info">COPY</button>
				  </p>
                  <p>Bank:<br>
				  <input type="text" value="<?php echo $bank ?>" style="width:100%;background:#f98604;color:#fff" readonly /><br>
			...
			<p style="background:#fff;padding:20px;color:#000;margin:15px"><span style="color:#f00">Note: </span> Only send Bitcoin to the above address. Sending any other coin could lead to permanent loss. After payment kindly upload a screen shot for faster confirmation.</p>
			 ...
			 <div class="card-footer">
                <button type="submit" name="bank_proof" class="btn btn-fill btn-warning">UPLOAD SCREEN SHOT</button>
              </div>
