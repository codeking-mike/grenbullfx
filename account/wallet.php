    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="row">
            ...
            <div class="card">
              ...
              ?>
                <h4>Deposit USDT</h4>
                <p>Kindly deposit <?php echo $amount ?> worth of USDT to the wallet address below.</p>

                <?php
                       }elseif($wallet_type == 'btc'){
                ?>
                 <h4>Deposit BTC</h4>
                <p>Kindly deposit <?php echo $amount ?> worth of BTC to the wallet address below.</p>
                <?php
                       }else{
                ?>
                <h4>Deposit ETH</h4>
                <p>Kindly deposit <?php echo $amount ?> worth of ETH to the wallet address below.</p>
              ...
              <div class="card-body">
				  ...
				  $check_inv = "SELECT * FROM central_account WHERE fund_type='$wallet_type'";
				  ...
				  <p>Wallet Address:<br>
				  <input type="text" id="link" value="<?php echo $wallet_address ?>" style="width:100%;background:#f98604;color:#fff" readonly /><br>
				  <button id="copy" onclick="copyLink2()" class="btn btn-info">COPY</button>
				  </p>
				  <p><img src="../qrcode/<?php echo $qrcode ?>" width="150" height="200" /> </p>
				  
				  
                  </div>
                  </div>
				<?php }  ?>
			<p style="background:#fff;padding:20px;color:#000;margin:15px"><span style="color:#f00">Note: </span> Only send <?php echo $wallet_type; ?> to the above address. Sending any other coin could lead to permanent loss. After payment kindly upload a screen shot for faster confirmation.</p>
			 ...
			 <div class="card-footer">
                <button type="submit" name="btc_proof" class="btn btn-fill btn-warning">UPLOAD SCREEN SHOT</button>
              </div>
