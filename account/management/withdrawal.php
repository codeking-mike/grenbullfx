...
function phpClear($m) {
  echo '<script type="text/javascript">if(confirm("Are you sure you want to delete withdrawal request?")) {
          window.location="processupdate.php?wid='. $m. '";
      } else {
        exit();
      }
      </script>';
          ...
          <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by date..">
                ...
                <div class="card-body table-responsive">
                  <div class="table-responsive">
                    ...
                    <tbody>
                      <?php
							$sq = "SELECT * FROM client_withdrawals WHERE completed='no' AND type='invest' ORDER BY with_id DESC";
                ...
                $nm = getUserName($receiver, $cxn);
								echo "<tr>
										...
										<td><a href='processwithdrawal.php?v=$with_id' class='btn btn-info'>PAY USER</a>
                    <a href='withdrawal.php?del=$with_id' class='btn btn-danger'>DELETE</a>
                    </td>
									 </tr>";
								$n++;
							}
