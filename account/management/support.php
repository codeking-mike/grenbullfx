...
if(isset($_GET['del'])){
	$del = $_GET['del'];
mysqli_query($cxn, "DELETE FROM support WHERE mid='$del'");	
                ...
                <div class="content table-responsive table-full-width" style="overflow-x:scroll !important;overflow-y:scroll !important;max-height:500px;">
                                <table class="table table-striped" style="overflow-x:scroll !important;overflow-y:scroll !important">
									...
									<?php  
                        				   ...
                        				   $qry = "SELECT * FROM notifications WHERE status='0' AND receiver='Admin'";
                                       ...
                                       $nm = getUserName($sender, $cxn);
                        						   echo "<tr> 
                        									...
                        									<td>$nm</td>
														    <td>$title</td>
                        								    <td><a href='viewmessages.php?sid=$id' style='background:#000;color:#fff;padding:10px'>Read</a></td>
															
															<td><a href='support.php?del=$id' style='background:#900;color:#fff;padding:10px'>Trash</a></td>";
