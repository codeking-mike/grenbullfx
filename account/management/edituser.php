            ...
            <div class="col-md-8">
              <div class="card">
				...
				<?php
				    if(isset($_GET['ed'])){
						$id = $_GET['ed'];
						$qr = "SELECT * FROM argent_client_db WHERE user_id = '$id'";
				...
				?>
                  <form action="processupdate.php" method="post">
                                    <div class="row">
                                      ...
                                      <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="country" class="form-control border-input" placeholder="country" value="<?php echo $country ?>" >
                                    ...
                                    <div class="text-center">
                                        <button type="submit" name="update" class="btn btn-warning btn-fill btn-wd" >Update User Profile</button>
                                        <a href="processupdate.php?clear=<?php echo $user_id ?>" class="btn btn-danger btn-fill">Clear User Wallet</a>
                                    </div>
