...
if(isset($_GET['trans'])){
	$trans = $_GET['trans'];
	mysqli_query($cxn, "DELETE FROM tbl_investments WHERE transid='$trans'");
...
<head>
  ...
  <!-- CSS Files -->
  <link href="../props/css/material-dashboard.css?v=2.1.1" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="../props/demo/demo.css" rel="stylesheet" />
  <?php
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <img src="../props/img/30logo.png" height="80" width="100" />
          </div>
		  ...
		  <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
				  <h4 class="card-title">Active Pairs</h4>
                  <p class="card-category">These are users that have been paired but payment have not been confirmed.</p>
                </div>
                <div class="card-body table-responsive">
                  <div class="table-responsive">
                    ...
                    <tbody>
                      <?php
							$sq = "SELECT * FROM mergetable WHERE fulfilled='no'";
							...
							while($row = mysqli_fetch_assoc($rs)){
								...
								echo "<tr>
										...
										<td><a href='viewinvest.php?id=$mergeid'>EDIT</a>/<a href='unmerge.php?id=$mergeid'>UNMERGE</a></td>
									 </tr>";
							}
