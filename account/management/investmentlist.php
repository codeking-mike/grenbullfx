        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-4">
              <div class="card card-stats">
                ...
                <div class="card-header text-dark card-header-icon">
                  
                  <p class="card-category">Active Investment</p>
            ...
            <div class="col-lg-4">
              <div class="card card-stats">
                ...
                <div class="card-header card-header-icon">
                  ...
                  <p class="card-category">Withdrawal Requests
                  <h3 class="card-title"><?php  
		  ...
		  <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header text-dark card-header-info">
				  <h4 class="card-title text-center">Running Investments</h4>
          <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by date.." style="width:100%;height:30">
                ...
                <div class="card-body table-responsive">
                  <div class="table-responsive">
                    ...
                    <tbody>
                      <?php
							$sq = "SELECT * FROM client_investment WHERE completed='no'";
                ...
                $nm = getUserName($payer, $cxn);
								echo "<tr>
										...
										<td>$expected_date</td>
										<td><a href='viewinvest.php?id=$fund_id' class='btn btn-warning'>EDIT</a>
										<a href='investmentlist.php?del=$fund_id' class='btn btn-danger btn-fill'>DELETE</a>
...
<!-- End view payment details -->
  ...
  <!-- Chartist JS -->
  <script src="../props/js/plugins/chartist.min.js"></script>
